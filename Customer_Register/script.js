...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById('registerForm').addEventListener('submit', function (event) {
        ...
        // Sending customer data to the server using Fetch API
        ...
        .then(data => {
            if (data.success) {
                ...
                validatemessage.innerHTML = data.message || 'Registration failed. Please try again.';
            }
        })
        .catch(error => {
            validatemessage.innerHTML = 'Error occurred during registration. Please try again later.';
